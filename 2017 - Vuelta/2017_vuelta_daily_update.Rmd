...
<br>
<br>
Thirty seven degree temperatures were not enough to slow the onslaught of the Quickstep-Floors team who upped the pace to drag in the breakaway with 8 kilometres to go and deliver their Italian sprinter Matteo Trentin to the perfect spot for the flat, stage finishing sprint. Trentin comfortably came around Juan José Lobato for the victory with Tom van Asbroeck in third. 
<br> 
<br>
There was no real change in GC standings with the exceptions of Rafa Majka strangely losing further time (while his team was driving the pace on the front of the peloton!) and Pozzovivo and Moreno being involved in a crash just shy of the 3km barrier. Pozzovivo drops out of the top ten and competition for the podium. Had the crash occured inside the 3km banner they would have received the same time as the peloton crossing the finish line.
<br> 
<br>
...
team_overall <- team_cu_scores %>%
  filter(stage == stage_no) %>% 
  select("Team" = team,  "Directer" = directeur, "Total" = cu_stage) %>% 
  arrange(desc(Total))
kable(team_overall)
# View(team_overall)
