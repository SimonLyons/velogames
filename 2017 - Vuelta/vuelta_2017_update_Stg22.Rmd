...
<br>
<br>
Dutch sprinter Dylan Groenewegen provided an upset victory over the more established fast-man favourites on the Champs-Élysées ahead of André Greipel, the biggest win of his career. Edvald Boasson Hagen finished third. All the jersey winnners arrived at the finish line safely in the pack, with Chris Froome taking his fourth Tour De France win.
<br>
<br>
<br>
<br>
...
<br>
<br>
https://www.velogames.com/vuelta-a-espana/2017/scores.php
<br>
<br>
...
<br>
The chart below demonstrates what a difference Romain Bardet made in the Velogames comp. Nario was clearly a disappointment, costing a lot an not delivering on that investment. Porte and Sagan languish in the extremely poor value section thanks to their early departure. Uran and Matthews stand out as being excellent value. 
...
<br>  
So `r team_stage_score[1,2]` cleaned up stage `r stage_no + 1`.
<br>  
...
stage_cu_podium <- as.data.frame(team_cu_scores) %>%
  filter(stage == as.integer(stage_no+1)) %>%
