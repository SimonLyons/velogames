...
<br>
<br>
The predicted attacks for Stage 13 eventuated early and by the time the riders reached the final ascent to the Mur de Péguère there were time splits on the road between some of the GC favourites. Frenchman Warren Barguil prevailed in a four man sprint to acheive the cycling dream of many countrymen of the bleu-blanc-rouge by winning a Tour De France stage on la Fête nationale. Barguil finished ahead of Contador, Quintana and Landa who all made up 1minute and 48 seconds on the group containing Fabio Aru, Froome, Bardet and Uran. GC placings are essentially unchanged, although both Landa and Quintana are now much closer to the overall lead.
<br> 
<br>
