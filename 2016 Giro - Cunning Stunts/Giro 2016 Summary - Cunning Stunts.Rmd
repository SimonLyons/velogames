...
With 7 teams in our 2016 Giro Velogames competition there was the opportunity for 7 unique teams and 63 riders in total. However the short list of favoured athletes in each category ultimately led us to select our squads from only 41 of the overall 198 riders starting the Giro in Apeldoorn on the 6th of May, 2016.
...
The ROI data is insightful in that it reveals which riders provided the best bang for buck. Although expensive picks such as Valverde and Nibali ultimately proved good investments, the three teams backing diminutive Columbian Esteban Chaves must have been cheering all the way to the Velocredit bank! Note - clearly the bargain pick at only 8 Velocredits was Bobby Jungels however the only team directeur savvy enough to select the lightweight Etixx Quickstep rider still finished with the wooden spoon....


### Overall Team Performance

At the end of a tightly fought three week battle the Fly Guys took top step on the podium by a very slim margin. However it required bonus point allocations on the final stage for Jeff's team to unseat Jamie's cheap legs who had taken the lead from Stage 1 and seemed destined for victory.
