...
for(s in 1:3){   # Loop through each of the four (4) leagues
  league_code <- league_codes$league_no[s]
  velo_url <- paste("https://www.velogames.com/tour-de-france/2017/leaguescores.php?league=", league_code, sep = "")
